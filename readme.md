...
The mappings of the MIDI Remote Script are available as an iMAP preset that you can [download]() and load into iMAP so the hardware button layout matches the layout of the MIDI Remote control surface.
