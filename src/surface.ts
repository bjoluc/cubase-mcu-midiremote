...
export function createControlSectionSurfaceElements(surface: DecoratedDeviceSurface, x: number) {
  ...
  return {
    ...
    buttons: {
      ...
      number: createElements(8, (index) => makeSquareButton(surface, x + 6 + index * 2.25, 10.5)),
      function: createElements(8, (index) => makeSquareButton(surface, x + 6 + index * 2.25, 14)),
      ...
      transport: [
        ...
        ...createElements(5, (index) => surface.makeLedButton(x + 6.25 + index * 3.56, 25, 3, 2)),
      ],
